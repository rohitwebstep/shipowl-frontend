...
const Update = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `sleeping-owl-we0m.onrender.com/api/product/request/${id}`;
    ...
    const handleImageDelete = async (index) => {
        ...
        try {
            ...
            const url = `sleeping-owl-we0m.onrender.com/api/product/request/my/${id}/image/${index}`;
    ...
    const fetchProducts = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my/${id}`,
                {
                    method: "GET",
                    headers: {
    ...
    const fetchCategory = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`sleeping-owl-we0m.onrender.com/api/admin/category`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
