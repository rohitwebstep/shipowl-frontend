...
export default function ProductList() {
    ...
    const fetchProducts = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my`,
                {
                    method: "GET",
                    headers: {
    ...
    const trashProducts = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my/trashed`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/product/request/my/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
