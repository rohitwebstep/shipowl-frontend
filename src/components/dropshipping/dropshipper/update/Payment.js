...
const Payment = () => {
    ...
    setFormData((prev) => ({
     ...
     const handleImageDelete = async (index,type) => {
              ...
              try {
                  ...
                  const url = `http://https://sleeping-owl-we0m.onrender.com/api/dropshipper/${formData.id}/company/${formData.companyid}/image/${index}?type=${type}`;
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    const url = `http://https://sleeping-owl-we0m.onrender.com/api/dropshipper/profile/update`;
