...
export default function List() {
    ...
    const totalPages = Math.ceil(brandData.length / perPage);
    const indexOfLast = currentPage * perPage;
    const indexOfFirst = indexOfLast - perPage;
    const currentData = brandData.slice(indexOfFirst, indexOfLast);
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b text-[#A3AED0] border-[#E9EDF7]">
                                    <th className="p-2 whitespace-nowrap pe-5 text-left uppercase">Brand Name<i></i></th>
                                ...
                                {currentData.map((item) => (
                                    <tr key={item.id} className="border-b border-[#E9EDF7] text-[#2B3674] font-semibold">
                                        ...
                                        <td className="p-2 whitespace-nowrap px-5">
                                            <Image src={item.brand_img} alt={item.name} className="h-8 w-8 me-3" />
