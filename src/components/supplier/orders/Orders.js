...
export default function Orders() {
  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://shipping-owl-vd4s.vercel.app/api/supplier/order?from=${formatDate(
          fromDate
  ...
  const handleShipping = useCallback(async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://shipping-owl-vd4s.vercel.app/api/order/${id}/shipping`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${suppliertoken}`,
        ...
        if (errorMessage.isHighRto === true) {
          Swal.fire({
            ...
            if (result.isConfirmed) {
              try {
                const confirmResponse = await fetch(`https://shipping-owl-vd4s.vercel.app/api/order/${id}/shipping/confirm`, {
                  method: 'POST',
                  headers: {
                    Authorization: `Bearer ${suppliertoken}`,
                  },
  ...
  const handleCancel = useCallback(async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://shipping-owl-vd4s.vercel.app/api/order/${id}/shipping/cancel`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${suppliertoken}`,
  ...
  const handleTracking = useCallback(async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://shipping-owl-vd4s.vercel.app/api/order/${id}/shipping/status`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${suppliertoken}`,
