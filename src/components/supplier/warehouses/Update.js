...
export default function Update() {
      ...
      const fetchCity = useCallback(async (id) => {
                ...
                try {
                    const response = await fetch(
                        `http://https://sleeping-owl-we0m.onrender.com/api/location/state/${id}/cities`,
                        {
                            method: "GET",
                            headers: {
        ...
        const fetchState = useCallback(async (value) => {
            ...
            try {
                const response = await fetch(
                    `http://https://sleeping-owl-we0m.onrender.com/api/location/country/${value}/states`,
                    {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
    ...
    const fetchwarehouse = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/warehouse/${id}`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `http://https://sleeping-owl-we0m.onrender.com/api/warehouse/${id}`;
  ...
  <div className="bg-white rounded-2xl p-5">
    <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
      <div>
        ...
        <input
          ...
          className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
            validationErrors.name ? 'border-red-500' : 'border-[#DFEAF2]'
          }`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
            validationErrors.gst_number ? 'border-red-500' : 'border-[#DFEAF2]'
          }`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
            validationErrors.contact_name ? 'border-red-500' : 'border-[#DFEAF2]'
          }`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
            validationErrors.contact_number ? 'border-red-500' : 'border-[#DFEAF2]'
          }`}
        />
    ...
    <div className="mt-4">
      ...
      <textarea
        ...
        className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
          validationErrors.address_line_1 ? 'border-red-500' : 'border-[#DFEAF2]'
        }`}
      />
    ...
    <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mt-3">
      ...
      <select
        ...
        id="country"
        className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
        validationErrors.country ? 'border-red-500' : 'border-[#DFEAF2]'
        }`}
      ...
      <div>
        ...
        <input
          ...
          placeholder="45962"
          className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
            validationErrors.postal_code ? 'border-red-500' : 'border-[#DFEAF2]'
          }`}
        />
      ...
      <select
        ...
        id="state"
        className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
        validationErrors.state ? 'border-red-500' : 'border-[#DFEAF2]'
        }`}
    ...
    <div>
      ...
      onChange={handleChange}
        ...
        value={formData.city}
        className={`text-[#718EBF] border w-full rounded-md p-3 mt-2 font-bold ${
          validationErrors.city ? 'border-red-500' : 'border-[#DFEAF2]'
        }`}>
