        ...
        <section className="add-warehouse xl:w-8/12">
            <div className="bg-white rounded-2xl p-5 ">
                <div className="grid md:grid-cols-2 grid-cols-1 gap-3">
                    <div>
                        <label htmlFor="" className="font-bold block text-[#232323]">Category Name</label>
                        <input type="text" name="" id="" className="text-[#718EBF] border w-full border-[#DFEAF2] rounded-md p-3 mt-2 font-bold" />
                    </div>
                    <div>
                        <label htmlFor="" className="font-bold block text-[#232323]">Category Description</label>
                        <input type="text" name="" id="" className="text-[#718EBF] border w-full border-[#DFEAF2] rounded-md p-3 mt-2 font-bold" />
                    </div>
                </div>
                <div className='mt-2'>
                    <label htmlFor="" className="font-bold block text-[#232323]">Category Image</label>
