...
export default function Update() {
    ...
    const fetchCategory = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/category/${id}`,
                {
                    method: "GET",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `http://https://sleeping-owl-we0m.onrender.com/api/category/${id}`;
        ...
        setFiles(selectedFiles);
          ...
          const handleImageDelete = async (index) => {
            ...
            try {
                ...
                const url = `http://https://sleeping-owl-we0m.onrender.com/api/category/${id}/image/${index}`;
