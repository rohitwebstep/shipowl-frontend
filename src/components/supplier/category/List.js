...
export default function List() {
    ...
    const { fetchCategory, categoryData, setFormData, setIsEdit } = useContext(CategoryContext)
                    ...
                    <div className="flex flex-wrap justify-between items-center mb-4">
                        ...
                        <div className="flex gap-3 flex-wrap items-center">
                            ...
                            <div className="flex justify-end">
                                <button className="bg-[#4285F4] text-white rounded-md p-2 px-4">
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b text-[#A3AED0] border-[#E9EDF7]">
                                            <th className="p-2 whitespace-nowrap pe-5 text-left uppercase">Category Name<i></i></th>
                                            <th className="p-2 whitespace-nowrap px-5 text-left uppercase">Image<i></i></th>
                                    ...
                                    <tbody>
                                        {currentData.map((item) => (
                                            <tr
                                                key={item.id}
                                                className="border-b border-[#E9EDF7] text-[#2B3674] font-semibold"
                                            >
                                                <td className="p-2 whitespace-nowrap pe-5">
                                                ...
                                                <td className="p-2 whitespace-nowrap px-5">
                                                    <Image
                                                        src={`https://sleeping-owl-we0m.onrender.com${item.image}`}
                                                        alt={item.name}
                                                        width={40}
                                                        height={40}
                                                ...
                                                <td className="p-2 whitespace-nowrap px-5">{item.description}</td>
