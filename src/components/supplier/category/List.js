                    ...
                    <div className="flex flex-wrap justify-between items-center mb-4">
                        ...
                        <button
                            ...
                            <div className="flex justify-end">
                                <button className='bg-[#4285F4] text-white rounded-md p-2 px-4'><Link href="/supplier/category/create">Add Catogary</Link></button>
                                ...
                                {currentData.map((item) => (
                                    <tr key={item.id} className="border-b border-[#E9EDF7] text-[#2B3674] font-semibold">
                                        ...
                                        <td className="p-2 whitespace-nowrap px-5">
                                            <Image src={item.cat_img} alt={item.name} className="h-8 w-8 me-3" />
