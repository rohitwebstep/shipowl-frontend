...
export default function List() {
    ...
    const trashedCategories = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/category/trashed`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/category/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            ...
            const results = await Promise.all(
                selected.map(id =>
                    fetch(`sleeping-owl-we0m.onrender.com/api/admin/category/${id}`, {
                        method: "DELETE",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: `Bearer ${suppliertoken}`,
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/category/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/category/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
