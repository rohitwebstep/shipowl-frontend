...
const ProductTable = () => {
    ...
    const fetchProduct = useCallback(async (type) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory?type=${type}`, {
                method: "GET",
                headers: {
    ...
    const trashProducts = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory/trashed`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${suppliertoken}`,
    ...
    const fetchCategory = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/supplier/category`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = isEdit ? `sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory/${inventoryData.id}` : "sleeping-owl-we0m.onrender.com/api/supplier/product/my-inventory";
