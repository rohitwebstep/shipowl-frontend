...
const ProfileEdit = () => {
    ...
    const { formData,validate ,errors,setErrors ,setFormData,fetchCountry, stateData,cityData, setCityData, setStateData,setActiveTab,countryData} = useContext(ProfileContext);
