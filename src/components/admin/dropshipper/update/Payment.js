...
const Payment = () => {
  ...
  const handleImageDelete = async (index, type) => {
    ...
    try {
      ...
      const url = `https://shipping-owl-vd4s.vercel.app/api/admin/${formData.id}/company/${formData.companyid}/image/${index}?type=${type}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = `https://shipping-owl-vd4s.vercel.app/api/admin/dropshipper/${formData?.id}/profile/update`;
