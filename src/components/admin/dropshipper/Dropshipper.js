                        ...
                        <table className="w-full" id="supplierTable">
                            <thead>
                                <tr className="border-b text-[#A3AED0] border-[#E9EDF7]">
                                    ...
                                    <th className="p-3 px-4 whitespace-nowrap text-left uppercase">Bank DEtails</th>
                                </tr>
                            </thead>
                            <tbody>
                                 ...
                                 const isExpanded = expandedSupplier === item.id;
                                    ...
                                    return (
                                        ...
                                        <tr key={item.id} className="border-b border-[#E9EDF7] text-[#2B3674] font-semibold">
                                            ...
                                            <td className="p-2 px-4 whitespace-nowrap text-left">{item.name || 'N/A'}</td>
                                            <td className="p-2 px-4 whitespace-nowrap text-left">{item.email || 'N/A'}</td>
                                            <td className="p-2 px-4 whitespace-nowrap text-left">{item.permanentAddress || 'N/A'}</td>
                                            <td className="p-2 px-4 whitespace-nowrap text-left">
                                                {(() => {
                                                    const filteredState = stateData.filter((state) => state.id === item.permanentStateId);
                                                    return filteredState.length > 0 ? filteredState[0].name : 'N/A';
                                                })()}
                                                </td>

                                                <td className="p-2 px-4 whitespace-nowrap text-left">
                                                {(() => {
                                                    const filteredCity = cityData.filter((city) => city.id === item.permanentCityId);
                                                    return filteredCity.length > 0 ? filteredCity[0].name : 'N/A';
                                                })()}
                                                </td>
