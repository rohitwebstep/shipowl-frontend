...
export default function Update() {
    ...
    const fetchCategory = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/category/${id}`,
                {
                    method: "GET",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `sleeping-owl-we0m.onrender.com/api/admin/category/${id}`;
        ...
        setFiles(selectedFiles);
          ...
          const handleImageDelete = async (index) => {
            ...
            try {
                ...
                const url = `sleeping-owl-we0m.onrender.com/api/admin/category/${id}/image/${index}`;
