...
const SupplierList = () => {
    ...
    const trashSupplier = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`sleeping-owl-we0m.onrender.com/api/admin/supplier/trashed`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${admintoken}`,
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/supplier/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `sleeping-owl-we0m.onrender.com/api/admin/supplier/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
     ...
     const handleRestore = useCallback(async (item) => {
            ...
            try {
                setLoading(true);
                const response = await fetch(
                    `sleeping-owl-we0m.onrender.com/api/admin/supplier/${item?.id}/restore`,
                    {
                        method: "PATCH",
                        headers: {
                            "Content-Type": "application/json",
