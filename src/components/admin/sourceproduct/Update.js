    ...
    const handleSubmit = async (e) => {
     ...
     const handleImageDelete = async (index) => {
                ...
                try {
                    ...
                    const url = `http://https://sleeping-owl-we0m.onrender.com/api/product/request/${id}/image/${index}`;
...
const fetchProducts = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/product/request/${id}`,
                {
                    method: "GET",
                    headers: {
