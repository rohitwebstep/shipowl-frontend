...
export default function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://shipping-owl-vd4s.vercel.app/api/bad-pincode", {
        method: "POST",
...
const handleBulkSubmit = async (e) => {
  ...
  try {
    ...
    const res = await fetch("https://shipping-owl-vd4s.vercel.app/api/bad-pincode/import", {
      method: "POST",
      headers: {
