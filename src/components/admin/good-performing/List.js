...
export default function List() {
    ...
    const fetchGoodPincode = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(
                `https://sleeping-owl-we0m.onrender.com/api/good-pincode`,
                {
                    method: "GET",
                    headers: {
    ...
    const trashedGoodPincode = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `https://sleeping-owl-we0m.onrender.com/api/good-pincode/trashed`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
            ...
            console.error("Error fetching trashed Good Performing:", error);
        } finally {
            setLoading(false);
        }
    }, [router, setData]);
    ...
    const handleEditItem = (item) => {
        router.push(`/admin/good-pincodes/update?id=${item.id}`);
    };
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `https://sleeping-owl-we0m.onrender.com/api/good-pincode/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `https://sleeping-owl-we0m.onrender.com/api/good-pincode/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `https://sleeping-owl-we0m.onrender.com/api/good-pincode/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                ...
                <div className="flex flex-wrap justify-between items-center mb-4">
                    ...
                    <div className="flex gap-3  flex-wrap items-center">
                        ...
                        <button
                            ...
                            <button className='bg-[#4285F4] text-white rounded-md p-3 px-8'><Link href="/admin/good-pincodes/create">Add New</Link></button>
                        </div>
                    </div>
                </div>
              {data.length > 0 ?(
