...
export default function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://shipping-owl-vd4s.vercel.app/api/good-pincode", {
        method: "POST",
...
const handleBulkSubmit = async (e) => {
  ...
  try {
    ...
    const res = await fetch("https://shipping-owl-vd4s.vercel.app/api/good-pincode/import", {
      method: "POST",
      headers: {
