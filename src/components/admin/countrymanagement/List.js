...
export default function List() {
    ...
    const currentData = countries.slice(indexOfFirst, indexOfLast);

    return (
        <>

            <div className="bg-white md:w-8/12 rounded-3xl p-5">
                <div className="flex flex-wrap justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold text-[#2B3674]">Country List</h2>
                    <div className="flex gap-3  flex-wrap items-center">
                        ...
                        <div className="flex justify-start gap-5 items-end">
                            <button className='bg-[#4285F4] text-white rounded-md p-3 px-8'><Link href="/admin/country/create">Add New</Link></button>
                        </div>
                    </div>
                </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b text-[#A3AED0] border-[#E9EDF7]">
                                <th className="p-2 whitespace-nowrap px-5 text-left uppercase">Country Code<i></i></th>
                                <th className="p-2 whitespace-nowrap px-5 text-left uppercase">currency<i></i></th>
                        ...
                        <tbody>
                            {currentData.map((item) => (
                                <tr key={item.id} className="border-b border-[#E9EDF7] text-[#2B3674] font-semibold">
                                    ...
                                    <td className="p-2 whitespace-nowrap px-5">{item.currency}<br /></td>
