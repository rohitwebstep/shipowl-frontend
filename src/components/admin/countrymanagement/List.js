...
export default function List() {
    ...
    const trashCountry = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/location/country/trashed`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/location/country/${item.id}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            ...
            const results = await Promise.all(
                selected.map(id =>
                    fetch(`http://https://sleeping-owl-we0m.onrender.com/api/location/country/${id}`, {
                        method: "DELETE",
                        headers: {
                            "Content-Type": "application/json",
                            Authorization: `Bearer ${admintoken}`,
    ...
    const handleRestore = useCallback(async (item) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/location/country/${item?.id}/restore`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePermanentDelete = async (item) => {
        ...
        try {
            ...
            const response = await fetch(
                `http://https://sleeping-owl-we0m.onrender.com/api/location/country/${item.id}/destroy`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
