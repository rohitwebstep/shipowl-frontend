...
function OrderPermission() {
    ...
    const fetchPermission = useCallback(() => {
        fetchProtected(
            "https://shipping-owl-vd4s.vercel.app/api/admin/supplier/order/permission",
            setPermission,
            "permissions",
            setLoading
        );
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await fetch("https://shipping-owl-vd4s.vercel.app/api/admin/supplier/order/permission", requestOptions);
