...
export default function Update() {
 ...
 const searchParams = useSearchParams();
  ...
  const fetchPincodes = useCallback(async () => {
    ...
    try {
        ...
        const response = await fetch(
            `https://shipping-owl-vd4s.vercel.app/api/high-rto/${id}`,
            {
                method: "GET",
                headers: {
  ...
  const fetchCity = useCallback(async (id) => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`https://shipping-owl-vd4s.vercel.app/api/location/state/${id}/cities`, {
        headers: {
          "Content-Type": "application/json",
  ...
  const fetchStateList = useCallback(async (id) => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`https://shipping-owl-vd4s.vercel.app/api/location/country/${id}/states`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const fetchCountryAndState = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`https://shipping-owl-vd4s.vercel.app/api/location/country`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://shipping-owl-vd4s.vercel.app/api/high-rto/${id}`, {
        method: "PUT",
